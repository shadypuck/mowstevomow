 ...
 */
function impact_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _impact_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function impact_html_head_alter(&$head_elements) {
...
function impact_preprocess_page(&$variables) {
  ...
  $layoutClass = _impact_get_layout();
 ...
 */
function impact_preprocess_block(&$vars) {
 ...
 */
function _impact_variable_get($key, $default) {
  global $theme;
 ...
 */
function _impact_get_layout() {
  $layout_patterns = _impact_variable_get('layout', array('<global>' => 'body-layout-fixed-ca'));
 ...
 */
function impact_node_view_alter(&$build) {
 ...
 */
function impact_preprocess_forum_topic_list(&$vars) {
 ...
 */
function impact_preprocess_comment_wrapper(&$vars) {
 ...
 */
function impact_preprocess_media_gallery_license(&$vars) {
