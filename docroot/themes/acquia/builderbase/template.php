 ...
 */
function builderbase_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _builderbase_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function builderbase_html_head_alter(&$head_elements) {
...
function builderbase_preprocess_page(&$variables) {
  ...
  $layoutClass = _builderbase_get_layout();
 ...
 */
function builderbase_preprocess_block(&$vars) {
 ...
 */
function _builderbase_variable_get($key, $default) {
  global $theme;
 ...
 */
function _builderbase_get_layout() {
  $layout_patterns = _builderbase_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function builderbase_node_view_alter(&$build) {
...
function builderbase_preprocess_forum_topic_list(&$vars) {
 ...
 */
function builderbase_preprocess_comment_wrapper(&$vars) {
 ...
 */
function builderbase_preprocess_media_gallery_license(&$vars) {
