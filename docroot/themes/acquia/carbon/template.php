 ...
 */
function carbon_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _carbon_get_layout();
}
 ...
 */
function carbon_preprocess_block(&$vars) {
 ...
 */
function carbon_node_view_alter(&$build) {
 ...
 */
function carbon_preprocess_comment_wrapper(&$vars) {
 ...
 */
function carbon_preprocess_media_gallery_license(&$vars) {
