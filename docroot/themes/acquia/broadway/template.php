 ...
 */
function broadway_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _broadway_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function broadway_html_head_alter(&$head_elements) {
...
function broadway_preprocess_page(&$variables) {
  ...
  $layoutClass = _broadway_get_layout();
 ...
 */
function broadway_preprocess_block(&$vars) {
 ...
 */
function _broadway_variable_get($key, $default) {
  global $theme;
 ...
 */
function _broadway_get_layout() {
  $layout_patterns = _broadway_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function broadway_node_view_alter(&$build) {
...
function broadway_preprocess_forum_topic_list(&$vars) {
 ...
 */
function broadway_preprocess_comment_wrapper(&$vars) {
 ...
 */
function broadway_preprocess_media_gallery_license(&$vars) {
