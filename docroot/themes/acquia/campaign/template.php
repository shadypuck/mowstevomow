 ...
 */
function campaign_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _campaign_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function campaign_html_head_alter(&$head_elements) {
...
function campaign_preprocess_page(&$variables) {
  ...
  $layoutClass = _campaign_get_layout();
 ...
 */
function campaign_preprocess_block(&$vars) {
 ...
 */
function _campaign_variable_get($key, $default) {
  global $theme;
 ...
 */
function _campaign_get_layout() {
  $layout_patterns = _campaign_variable_get('layout', array('<global>' => 'body-layout-fixed-ca'));
 ...
 */
function campaign_node_view_alter(&$build) {
...
function campaign_preprocess_forum_topic_list(&$vars) {
 ...
 */
function campaign_preprocess_comment_wrapper(&$vars) {
 ...
 */
function campaign_preprocess_media_gallery_license(&$vars) {
