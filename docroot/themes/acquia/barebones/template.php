 ...
 */
function barebones_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _barebones_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function barebones_html_head_alter(&$head_elements) {
...
function barebones_preprocess_page(&$variables) {
  ...
  $layoutClass = _barebones_get_layout();
 ...
 */
function barebones_preprocess_block(&$vars) {
 ...
 */
function _barebones_variable_get($key, $default) {
  global $theme;
 ...
 */
function _barebones_get_layout() {
  $layout_patterns = _barebones_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function barebones_node_view_alter(&$build) {
...
function barebones_preprocess_forum_topic_list(&$vars) {
 ...
 */
function barebones_preprocess_comment_wrapper(&$vars) {
 ...
 */
function barebones_preprocess_media_gallery_license(&$vars) {
