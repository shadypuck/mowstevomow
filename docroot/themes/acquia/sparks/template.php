 ...
 */
function sparks_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _sparks_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function sparks_html_head_alter(&$head_elements) {
...
function sparks_preprocess_page(&$variables) {
  ...
  $layoutClass = _sparks_get_layout();
 ...
 */
function sparks_preprocess_block(&$vars) {
 ...
 */
function _sparks_variable_get($key, $default) {
  global $theme;
 ...
 */
function _sparks_get_layout() {
  $layout_patterns = _sparks_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function sparks_node_view_alter(&$build) {
...
function sparks_preprocess_forum_topic_list(&$vars) {
 ...
 */
function sparks_preprocess_comment_wrapper(&$vars) {
 ...
 */
function sparks_preprocess_media_gallery_license(&$vars) {
