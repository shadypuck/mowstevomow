 ...
 */
function sonoma_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _sonoma_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function sonoma_html_head_alter(&$head_elements) {
...
function sonoma_preprocess_page(&$variables) {
  ...
  $layoutClass = _sonoma_get_layout();
 ...
 */
function sonoma_preprocess_block(&$vars) {
 ...
 */
function _sonoma_variable_get($key, $default) {
  global $theme;
 ...
 */
function _sonoma_get_layout() {
  $layout_patterns = _sonoma_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function sonoma_node_view_alter(&$build) {
...
function sonoma_preprocess_forum_topic_list(&$vars) {
 ...
 */
function sonoma_preprocess_comment_wrapper(&$vars) {
 ...
 */
function sonoma_preprocess_media_gallery_license(&$vars) {
